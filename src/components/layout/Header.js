...
export default function Navbar() {
  ...
  return (
    <>
      ...
      ">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-16 sm:h-20 flex items-center justify-between">
          ...
          ">
            ...
            {mounted && session && <li><Link href="/orders" className="text-gray-700 hover:text-[#D4AF37] transition py-2 font-semibold">Orders</Link></li>}
          </ul>
      ...
      <div suppressHydrationWarning className="h-16 sm:h-20 lg:h-20" />
    </>
  );
}